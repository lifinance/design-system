...
Run `npx shadcn@latest info --json` to load the project config and installed components, then work from that output. Use `npx shadcn@latest docs <component>` to get documentation and example URLs for any component.
...
The project context from `npx shadcn@latest info` contains these key fields:
...
1. **Get project context** — run `npx shadcn@latest info` (see [Current Project Context](#current-project-context)). Refresh it whenever the project config or installed components change.
