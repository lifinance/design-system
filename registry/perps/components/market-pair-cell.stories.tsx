...
const meta = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"A compact market pair display with an avatar and metadata badges. Install with `pnpm dlx shadcn@latest add @perps/market-pair-cell`.",
			},
		},
		design: {
			type: "figma",
...
export const Primitives: Story = {
	render: () => (
		<div className="flex items-center gap-4">
			...
			<Badge variant="secondary">xyz</Badge>
		</div>
	),
};
