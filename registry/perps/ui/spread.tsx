...
function Spread({
	...
	return (
		<div data-slot="spread" className={cn("cn-spread", className)} {...props}>
			<div className="cn-spread-start">{start}</div>
			<div className="cn-spread-center">{children}</div>
			<div className="cn-spread-readout">
				<span>{label}:</span>
				<span>
					{currencySymbol}
