...
type TabsListProps = TabsPrimitive.List.Props &
	(
		| { variant?: "default" | "line"; size?: "default" }
		| { variant: "pill"; size?: "default" | "lg" | "xs" }
	);
	...
	return (
		<TabsPrimitive.Tab
			...
			className={cn(
				...
				"group-data-[variant=line]/tabs-list:bg-transparent group-data-[variant=line]/tabs-list:text-muted-foreground group-data-[variant=line]/tabs-list:data-active:bg-transparent group-data-[variant=line]/tabs-list:data-active:text-foreground dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-transparent",
				"group-data-[variant=pill]/tabs-list:border-input group-data-[variant=pill]/tabs-list:bg-input/30 group-data-[variant=pill]/tabs-list:text-muted-foreground group-data-[variant=pill]/tabs-list:data-active:bg-foreground/10 group-data-[variant=pill]/tabs-list:data-active:text-foreground dark:group-data-[variant=pill]/tabs-list:data-active:border-input dark:group-data-[variant=pill]/tabs-list:data-active:bg-foreground/10",
