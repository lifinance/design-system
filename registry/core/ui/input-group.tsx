...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: an input group exposes the group role over its controls
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useKeyWithClickEvents: clicking the addon focuses the input, which stays keyboard-accessible on its own
		// biome-ignore lint/a11y/useSemanticElements: an input group addon exposes the group role over its controls
		<div
			role="group"
